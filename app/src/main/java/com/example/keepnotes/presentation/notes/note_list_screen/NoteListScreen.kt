...
import com.example.keepnotes.presentation.notes.note_list_screen.components.NoteItem
import com.example.keepnotes.presentation.notes.note_list_screen.components.OrderSection
    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                ...
                IconButton(onClick = { viewModel.onEvent(event = NotesEvent.ToggleOrderSelection)}) {
